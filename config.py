...
#--------------------------------------------
FSUB_LINK_EXPIRY = int(os.getenv("FSUB_LINK_EXPIRY", "90"))  # 0 means no expiry
...
"""
#--------------------------------------------
CUSTOM_CAPTION = os.environ.get("CUSTOM_CAPTION", "<b>• ʙʏ @SpkLinks</b>") #set your Custom Caption here, Keep None for Disable Custom Caption
